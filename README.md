...
| [subagent-driven-development](workflow/subagent-driven-development/) | Execute implementation plans via fresh subagents per task with two-stage review (spec compliance then code quality) |
